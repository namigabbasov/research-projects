...
for (i in seq_along(folds)) {
  ...
  # Remove 'stab_ipw' and 'conflict_id' from training data passed to the model
  train_data <- train_data %>% select(-stab_ipw, -conflict_id)
  
  # Train the Random Survival Forest model with stabilized IPWs and cluster by 'conflict_id'
  rsf <- rfsrc(Surv(time_to_recur_any, recur_any) ~ ., data = train_data, 
               ntree = 1000, nodesize = 5, nsplit = 50, importance = TRUE, 
...
# Step 1: Estimate Propensity Scores with Logistic Regression Model
...
# Step 2: Calculate Raw Weights for ATE
...
# Step 4: Define Love Plot Function to Check Covariate Balance
...
# Step 5: Calculate SMD for Covariate Balance (Before and After Weighting)
...
# Step 6: Alternative Approach - Check Balance Using Survey Package
...
# Step 7: Trim Extreme Propensity Scores
...
# Step 8: Covariate Balance Check After Trimming
...
# Step 9: Estimate Causal Effect with Cox Proportional Hazards Model
